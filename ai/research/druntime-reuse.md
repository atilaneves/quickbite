...
[#561], `_d_arrayctor` and its `TypeInfo` path [#562], allocation and length
[#565], append and reserve [#566], exception chaining [#568], concatenation
[#569], and dead policy cleanup [#570]. Bytecode convergence is tracked in
issue #540.
