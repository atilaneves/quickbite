...
public import quickbite.ffi.symbol:
    CompilerAbi, DependencyImage, loadDependencyImages, verifyDependencyImages;
...
private CompilerAbi compilerAbiFor(in void* symbol) {
    import quickbite.ffi.symbol: compilerAbiFor;

    if (auto compilerAbi = cast(const(void)*) symbol in _closureAbis)
        return *compilerAbi;
    return compilerAbiFor(symbol);
}
