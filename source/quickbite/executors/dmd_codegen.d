module quickbite.executors.dmd_codegen;
...
private CodegenSession generateCodegenSession(
    ...
    addModule(module_);
    // Add executor runtime support modules (core.internal.newaa etc.) — these
    ...
    foreach (currentModule; modules) {
        // DMD code generator keeps the generated zero-initializer helper in this
...
private void resetBackendSymbol(void* csym) @trusted {
    ...
    // DMD caches codegen symbols on frontend declarations after object
    // generation. Reusing those symbols in the next in-process codegen pass
    // makes codegen believe it already owns an object-file symbol number,
...
private void resetBzeroInitializer(ref void* initializer) @trusted {
    ...
    // Aggregate default initializers can cache the code generator's zero-fill helper.
