...
package struct Colored (T)
{
    ...
    /// Hook for `formattedWrite` — template accepts any sink safety level so
    /// std.format can instantiate with its internally-created @system delegates.
    public void toString(Sink)(scope Sink sink)
    {
